...
/// 카드: 바바리안 전사
/// </summary>
public class Card_IceWolf : Card
{
    // --- 생성자 ---
        ...
        : base(owner, index, 7.0f,"card_icewolf") // 부모(Card) 생성자 호출 (쿨타임 7.0초)
    {
        ...
        this.CardImage = Resources.Load<Sprite>("CardImages/Lord_SevereCold/IceWolf");
        SetInitPrice(2);
        ...
        // --- 3. 툴팁 정보 설정 (키 할당) ---
        this.CardSkillDescriptionKey = "card_ice_wolf_skill_desc";
        this.FlavorTextKey = "card_ice_wolf_flavor";
